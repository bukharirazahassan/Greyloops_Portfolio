...
export default function WhyChooseUs() {
  return (
    <section className="service-font relative w-full bg-slate-50 border-t border-slate-200 py-16 px-6 sm:px-12 lg:px-16 xl:px-24 text-slate-900">
      <style jsx global>{`
      ...
      <div className="relative z-10 w-full mx-auto">
        {/* Section Header - Full width left-aligned layout */}
        <div className="text-left w-full mb-10">
          ...
          <h2 className="service-display mb-6 text-3xl font-extrabold tracking-tight leading-[1.1] sm:text-4xl md:text-5xl">
        ...
        {/* Main layout container with reduced gap and strict column inversion for Row 2 */}
        <div className="flex flex-col gap-4 w-full">
          
          {/* Row 1: Left Image (58%) + Right Dark Card (42%) */}
          <div className="relative w-full flex flex-col lg:flex-row items-stretch gap-4">
            
            <div className="relative w-full lg:w-[58%] aspect-[1376/768] shrink-0 bg-slate-900 shadow-2xl rounded-3xl overflow-hidden">
              <Image
            ...
            <div className="relative w-full lg:w-[42%] bg-slate-900 text-slate-100 p-8 sm:p-10 lg:p-12 flex flex-col justify-center rounded-3xl shadow-xl shadow-blue-900/10">
              <div className="relative z-10 flex flex-col items-start">
                ...
                <h3 className="service-display text-lg font-bold leading-snug text-white sm:text-xl lg:text-2xl">
          ...
          {/* Row 2: Left Side Two Cards (58% width, matching Row 1 top image) + Right Side Bottom Image (42% width, matching Row 1 top right card) */}
          <div className="relative w-full flex flex-col lg:flex-row items-stretch gap-4">
            
            {/* Left Side Two Cards (58%) */}
            <div className="w-full lg:w-[58%] flex flex-col gap-4 justify-between">
            ...
            {/* Right Side Bottom Image (42%) */}
            <div className="relative w-full lg:w-[42%] min-h-[650px] lg:min-h-[750px] rounded-3xl overflow-hidden shadow-2xl bg-slate-900">
              <Image
