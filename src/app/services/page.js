      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-slate-50 via-white to-blue-50/60 py-20 sm:py-28">
        ...
        <div className="relative mx-auto max-w-6xl px-6 text-center">
          ...
          <p className="mx-auto max-w-2xl text-lg leading-relaxed text-zinc-600">
            From product design to enterprise infrastructure, our teams
            partner with you at every stage — combining engineering depth
            with a product mindset to ship work that actually moves the
            needle.
          </p>
        </div>
      </section>
